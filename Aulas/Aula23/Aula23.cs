...
class Aula22{
    ...
    Random random=new Random(); //Random para gerar valor aleatorio
    for(int i = 0; i < vetor1.Length; i++){
        vetor1[i]=random.Next(50);// 50 indica o valor maximo
        }
        ...
        // public static int BinarySearch(Array,valor); retornar a posição do elemento procurado (obs: -1 significa que não está no array) 
